        ...
        <div className="rowaadhar1">
          ...
          {resumeData && (
            <div style={{ display: "flex", flexWrap: "wrap", width: "69%" }}>
              <div
                className="aadharCardDetail2"
                style={{ width: "35%", minHeight: "15.583vh" }}
              >
                ...
                <div className="ocrDetail">
                  <>
                    ...
                    <div className="nameDetail">
                      {" "}
                      DOB :{" "}
                      <span className="nameValue">{resumeData?.DOB[0]}</span>
                    </div>
                    {/* <div className="nameDetail">
                      {" "}
                ...
                <div className="ocrDetail">
                  <>
                    ...
                    <div className="nameDetail">
                      {" "}
                      Email Address :{" "}
                      <span className="nameValue">{resumeData?.E_mail}</span>
                    </div>
                    {/* <div className="nameDetail">
                      {" "}
              ...
              >
                ...
                <div className="ocrDetail">
                  <>
                    {/* <div className="nameDetail">
                      {" "}
                      Role : <span className="nameValue"></span>
                    </div> */}
                    {/* <div className="nameDetail">
                      {" "}
